...
sudo /usr/local/cuda-12.1/nsight-compute-2023.1.1/target/linux-desktop-glibc_2_11_3-x64/ncu --config-file off --export /home/ubuntu/cs246-project/tiny-nerf/pytorch/output/tiny_nerf --force-overwrite --set full /opt/conda/bin/python /home/ubuntu/cs246-project/tiny-nerf/pytorch/tiny_nerf_pytorch_train.py >> /home/ubuntu/cs246-project/tiny-nerf/pytorch/output/tiny_nerf_ncu.out;
nsys profile --stats=true --output=/home/ubuntu/cs246-project/tiny-nerf/pytorch/output/tiny_nerf /opt/conda/bin/python /home/ubuntu/cs246-project/tiny-nerf/pytorch/tiny_nerf_pytorch_train.py >> /home/ubuntu/cs246-project/tiny-nerf/pytorch/output/tiny_nerf_nsys.out;
cd ../..;
...
nsys profile --stats=true --output=/home/ubuntu/cs246-project/tiny-garf/output/tiny_garf_gelu /opt/conda/bin/python /home/ubuntu/cs246-project/tiny-garf/gelu_train.py >> /home/ubuntu/cs246-project/tiny-garf/output/tiny_garf_gelu_nsys.out;
...
nsys profile --stats=true --output=/home/ubuntu/cs246-project/tiny-garf/output/tiny_garf_relu /opt/conda/bin/python /home/ubuntu/cs246-project/tiny-garf/relu_train.py >> /home/ubuntu/cs246-project/tiny-garf/output/tiny_garf_relu_nsys.out;

echo "BEGIN tiny garf gabor";
sudo /usr/local/cuda-12.1/nsight-compute-2023.1.1/target/linux-desktop-glibc_2_11_3-x64/ncu --config-file off --export /home/ubuntu/cs246-project/tiny-garf/output/tiny_garf_gabor --force-overwrite --set full /opt/conda/bin/python /home/ubuntu/cs246-project/tiny-garf/gabor_train.py >> /home/ubuntu/cs246-project/tiny-garf/output/tiny_garf_gabor_ncu.out;
nsys profile --stats=true --output=/home/ubuntu/cs246-project/tiny-garf/output/tiny_garf_gabor /opt/conda/bin/python /home/ubuntu/cs246-project/tiny-garf/gabor_train.py >> /home/ubuntu/cs246-project/tiny-garf/output/tiny_garf_gabor_nsys.out;
...
nsys profile --stats=true --output=/home/ubuntu/cs246-project/tiny-garf/output/tiny_garf_sin /opt/conda/bin/python /home/ubuntu/cs246-project/tiny-garf/sin_train.py >> /home/ubuntu/cs246-project/tiny-garf/output/tiny_garf_sin_nsys.out;
